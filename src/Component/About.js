...
export default function About() {
  return (
    <>
      <Navbar/>
      <div className='about_head bg-black p-2'>
        <h1 className="flex justify-center text-5xl font-serif font-bold text-white">About</h1>
      <div className=" about w-2/3 h-auto m-auto text-2xl font-normal bg-slate-800 text-slate-200 p-12 rounded-3xl mt-4 mb-2">
