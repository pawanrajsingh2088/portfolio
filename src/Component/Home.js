        ...
        <>
            ...
            <div className=" main back w-screen justify-evenly h-96 flex gap-20 px-10 items-center">
                ...
                <div className=" main_body flex-col items-center justify-center">
                    ...
                    <div className="main_head text-3xl font-semibold text-gray-500 mt-3">Developer</div>
            ...
            <div className="education w-screen flex-col">
                <h1 className="flex w-screen h-24 text-4xl text-black font-bold justify-center font-serif items-center">Educational Details</h1>
            ...
            <div className="skills flex flex-col w-screen justify-between items-center bg-slate-200 mt-5 pb-8">
                <h1 className="flex w-screen p-2 text-4xl text-black font-bold font-serif justify-center items-center">Skills</h1>
