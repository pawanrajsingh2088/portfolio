...
export default function Footer() {
    return (
        <>
            <div className=" footer flex w-screen items-center justify-evenly gap-40 py-4 bg-gray-600">
                <h1 className=" footer_text text-2xl font-semibold text-slate-100">&copy;All Right Reserved @pawanrajsingh | 2024</h1>
                <div className=" footer_img flex gap-8">
                    ...
                    <Link target='_blank' to="https://www.instagram.com/pawan_raj_singh_2088/">
